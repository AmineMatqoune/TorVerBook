...
public class DBManager {
	...
	public boolean updateAccountInfo(Account accountObj, AccountType accountType, String actualUsername) throws SQLException, ClassNotFoundException {
		init();
	...
	public ResultSet checkIsFavouriteAd(long adId, String username) throws ClassNotFoundException, SQLException {
		init();
	...
	public boolean deleteAd(long id) throws SQLException, ClassNotFoundException {
		init();
